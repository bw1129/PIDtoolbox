...
I am not an engineer, and what I know about control theory is limited to my 3-4 year experience with miniquads. So for engineer types out there, some aspects of PIDtoolbox might seem unconventional. That said, I'm a neuroscientist with about ~15ys experience <a href="https://sites.google.com/site/bjw112968/" target="blank">publishing</a> on the neural basis of oculomotor control, which believe it or not has similarities to the flight characteristics and data associated with miniquads <a href="https://www.youtube.com/watch?v=UEqraYeP7Qs" target="blank">(e.g.)</a>. PIDtoolbox was also partly inspired by Plasmatree PID-analyzer (https://github.com/Plasmatree/PID-Analyzer), and the goal was to extend some of that type of functionality here in a GUI-based program.
