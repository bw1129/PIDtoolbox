...
guiHandlesSpec.specPresets = uicontrol(PTspecfig,'Style','popupmenu','string',{'PRESETS:'; '  1. [A+B] Gyro prefilt | Gyro'  ; '  2. [A+B] Gyro | Dterm' ; '  3. [A+B] Fterm | PIDsum' ; '  4. [A+B] Set point | PID error'; '  5. [A+B] Motors 1-2 | Motors 3-4' ; '  6. [A+B] Debug 1-2 | Debug 3-4' ;  '  7. [A] Gyro prefilt | Gyro | Pterm | Dterm' ; '  8. [A] Gyro prefilt | Gyro | Dterm prefilt | Dterm' ; '  9. [A] Pterm | Dterm | Fterm | PIDsum ' ;'  10. [A] Gyro | Dterm | Set point | PID error' ; '11. [A] Motors 1-2 | Motors 3-4' ;  '12. [A] Debug 1-2 | Debug 3-4'; '13. [B] Gyro prefilt | Gyro | Pterm | Dterm' ; '14. [B] Gyro prefilt | Gyro | Dterm prefilt | Dterm'; '15. [B] Pterm | Dterm | Fterm | PIDsum ' ; '16. [B] Gyro | Dterm | Set point | PID error' ; '17. [B] Motors 1-2 | Motors 3-4'; '18. [B] Debug 1-2 | Debug 3-4'},...
    ...
    'if guiHandlesSpec.specPresets.Value == 14, guiHandlesSpec.SpecSelect{1}.Value=16; guiHandlesSpec.SpecSelect{2}.Value=14; guiHandlesSpec.SpecSelect{3}.Value=19; guiHandlesSpec.SpecSelect{4}.Value=20; guiHandlesSpec.Sub100HzCheck{1}.Value=0; guiHandlesSpec.Sub100HzCheck{2}.Value=0; guiHandlesSpec.Sub100HzCheck{3}.Value=0; guiHandlesSpec.Sub100HzCheck{4}.Value=0; end;',...
    'if guiHandlesSpec.specPresets.Value == 15, guiHandlesSpec.SpecSelect{1}.Value=16; guiHandlesSpec.SpecSelect{2}.Value=14; guiHandlesSpec.SpecSelect{3}.Value=21; guiHandlesSpec.SpecSelect{4}.Value=20; guiHandlesSpec.Sub100HzCheck{1}.Value=0; guiHandlesSpec.Sub100HzCheck{2}.Value=0; guiHandlesSpec.Sub100HzCheck{3}.Value=0; guiHandlesSpec.Sub100HzCheck{4}.Value=0; end;',...
    'if guiHandlesSpec.specPresets.Value == 16, guiHandlesSpec.SpecSelect{1}.Value=19; guiHandlesSpec.SpecSelect{2}.Value=19; guiHandlesSpec.SpecSelect{3}.Value=22; guiHandlesSpec.SpecSelect{4}.Value=23; guiHandlesSpec.Sub100HzCheck{1}.Value=0; guiHandlesSpec.Sub100HzCheck{2}.Value=0; guiHandlesSpec.Sub100HzCheck{3}.Value=0; guiHandlesSpec.Sub100HzCheck{4}.Value=0; end;',...
    'if guiHandlesSpec.specPresets.Value == 17, guiHandlesSpec.SpecSelect{1}.Value=15; guiHandlesSpec.SpecSelect{2}.Value=19; guiHandlesSpec.SpecSelect{3}.Value=18; guiHandlesSpec.SpecSelect{4}.Value=17; guiHandlesSpec.Sub100HzCheck{1}.Value=0; guiHandlesSpec.Sub100HzCheck{2}.Value=0; guiHandlesSpec.Sub100HzCheck{3}.Value=1; guiHandlesSpec.Sub100HzCheck{4}.Value=1; end;',...
