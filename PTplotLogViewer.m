...
try   
    ...
    fontsz=(screensz_multiplier*prop_max_screen);
        ...
        if plotall_flag>=0 
            guiHandles.checkbox0.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox1.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox2.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox3.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox4.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox5.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox6.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox7.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox8.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox9.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox10.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox11.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox12.Value=guiHandles.checkbox14.Value;
            guiHandles.checkbox13.Value=guiHandles.checkbox14.Value;
        end
        plotall_flag=-1;
        ...
        if ~isempty(fnameMaster)
            for ii=1:3  
                ...
                if  ~expandON || (expandON && eval(['~isempty(hexpand' int2str(ii) ')']))
                    ...
                    if guiHandles.checkbox4.Value && ii<3, h=plot(tta{guiHandles.FileNum.Value}/us2sec, eval([ 'T{guiHandles.FileNum.Value}.axisD_' int2str(ii-1) '_' ]));hold on;set(h,'color', [linec.col4],'LineWidth',guiHandles.linewidth.Value), end
                    if guiHandles.checkbox5.Value, h=plot(tta{guiHandles.FileNum.Value}/us2sec, eval([ 'T{guiHandles.FileNum.Value}.axisF_' int2str(ii-1) '_' ]));hold on;set(h,'color', [linec.col5],'LineWidth',guiHandles.linewidth.Value), end
                    if guiHandles.checkbox6.Value, h=plot(tta{guiHandles.FileNum.Value}/us2sec, eval([ 'T{guiHandles.FileNum.Value}.setpoint_' int2str(ii-1) '_' ]));hold on;set(h,'color', [linec.col6],'LineWidth',guiHandles.linewidth.Value), end
                    if guiHandles.checkbox7.Value, h=plot(tta{guiHandles.FileNum.Value}/us2sec, eval([ 'T{guiHandles.FileNum.Value}.pidsum_' int2str(ii-1) '_' ]));hold on;set(h,'color', [linec.col7],'LineWidth',guiHandles.linewidth.Value), end
                    if guiHandles.checkbox8.Value, h=plot(tta{guiHandles.FileNum.Value}/us2sec, eval([ 'T{guiHandles.FileNum.Value}.piderr_' int2str(ii-1) '_' ]));hold on;set(h,'color', [linec.col8],'LineWidth',guiHandles.linewidth.Value), end
                    if guiHandles.checkbox9.Value, h=plot(tta{guiHandles.FileNum.Value}/us2sec, (T{guiHandles.FileNum.Value}.setpoint_3_/10)*(maxY/100) -(maxY*2));hold on;set(h,'color', [linec.col9],'LineWidth',guiHandles.linewidth.Value), end
